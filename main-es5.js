...
var FourwardFormComponent = /** @class */ (function () {
    function FourwardFormComponent(fb) {
        this.fb = fb;
        this.fields = [];
    ...
    FourwardFormComponent.prototype.ngOnInit = function () {
        this.generateReactiveForm();
    };
    FourwardFormComponent.prototype.actionButton1Click = function () {
        this.actionBtn1Click.emit(this.submitForm());
    };
    FourwardFormComponent.prototype.actionButton2Click = function () {
        this.actionBtn2Click.emit(this.submitForm());
    };
    FourwardFormComponent.prototype.cancelButtonClick = function () {
        this.fourwardFormGroup.reset();
        this.cancelBtnClick.emit();
    };
    FourwardFormComponent.prototype.submitForm = function () {
        this.isSubmited = true;
        var formResult = new _field_form__WEBPACK_IMPORTED_MODULE_3__["FormResult"]();
    ...
    FourwardFormComponent.prototype.generateReactiveForm = function () {
        var _this = this;
        var controls = {};
        this.fields.forEach(function (el) {
            controls[el.name] = _this.prepareFieldControl(el);
        });
        this.fourwardFormGroup = this.fb.group(controls);
    };
    FourwardFormComponent.prototype.prepareFieldControl = function (field) {
        var defaultValue = field.type === _field_form__WEBPACK_IMPORTED_MODULE_3__["FieldType"].DROPDOWN ? field.options[0].value : field.defaultValue;
    ...
    FourwardFormComponent.ctorParameters = function () { return [
...
var FourwardFormModule = /** @class */ (function () {
    function FourwardFormModule() {
    }
...
var FourwardFormService = /** @class */ (function () {
    function FourwardFormService() {
    ...
    */
    FourwardFormService.prototype.dataFormAction1 = function (senderComponent) {
        this.submitFormAction1Subject.next(senderComponent);
    };
    FourwardFormService.prototype.dataFormAction2 = function (senderComponent) {
        this.submitFormAction2Subject.next(senderComponent);
    };
    FourwardFormService.prototype.dataFormAction3 = function (senderComponent) {
    ...
    */
    FourwardFormService.prototype.sendFormData1 = function (formData) {
        this.sendDataFormAction1.next(formData);
    };
    FourwardFormService.prototype.sendFormData2 = function (formData) {
        this.sendDataFormAction2.next(formData);
    };
    FourwardFormService.prototype.sendFormData3 = function (formData) {
        this.sendDataFormAction3.next(formData);
    };
    /* Recriando formulario em Modo lazy */
    FourwardFormService.prototype.recriateForm = function (fieldForms) {
...
var FourwardInputMaskComponent = /** @class */ (function () {
    function FourwardInputMaskComponent() {
    ...
    FourwardInputMaskComponent_1 = FourwardInputMaskComponent;
    FourwardInputMaskComponent.prototype.ngOnInit = function () {
        this.setDefaultMaxLength();
        this.setFormatMask();
    };
    FourwardInputMaskComponent.prototype.changeEvent = function (event) {
        this.setDefaultMaxLength();
        var noFormatText = event;
        if (this.type !== InputType.NO_FORMAT) {
            noFormatText = event.replace(/\D/g, '');
        }
        var inputField = document.querySelector('#' + this.id);
        ...
        if (this.type === InputType.CURRENCY || this.type === InputType.PERCENT) {
            var numberValue = this.value.replace('.', '');
    ...
    FourwardInputMaskComponent.prototype.writeValue = function (obj) {
        if (obj) {
            this.type === InputType.CPF
    ...
    FourwardInputMaskComponent.prototype.registerOnChange = function (fn) {
        this.propagateOnChange = fn;
    };
    FourwardInputMaskComponent.prototype.registerOnTouched = function (fn) {
        // todo
    };
    FourwardInputMaskComponent.prototype.setDisabledState = function (isDisabled) {
        this.disabled = isDisabled;
    };
    FourwardInputMaskComponent.prototype.formatToCpf = function (v) {
    ...
    FourwardInputMaskComponent.prototype.formatToCnpj = function (v) {
        v = v.replace(/\D/g, ''); // Remove tudo o que não é dígito
    ...
    FourwardInputMaskComponent.prototype.formatToPhone = function (v) {
        v = v.replace(/\D/g, ''); // Remove tudo o que não é dígito
        if (v.length <= 5) {
    ...
    FourwardInputMaskComponent.prototype.formatToCurrency = function (v) {
        v = v.replace(/\D/g, '');
        if (v.length === 3) {
    ...
    FourwardInputMaskComponent.prototype.formatToPercent = function (v) {
        v = v.replace(/\D/g, '');
        if (v.length >= 3) {
    ...
    FourwardInputMaskComponent.prototype.formatToNumber = function (v) {
        v = v.replace(/\D/g, '');
        return v;
    };
    FourwardInputMaskComponent.prototype.formatToZipCode = function (v) {
        v = v.replace(/\D/g, '');
        if (v.length === 3) {
    ...
    FourwardInputMaskComponent.prototype.formatToNothing = function (v) {
        return v;
    };
    FourwardInputMaskComponent.prototype.setDefaultMaxLength = function () {
    ...
    FourwardInputMaskComponent.prototype.setFormatMask = function () {
        var _this = this;
        this.maskFormatMap.set(InputType.CPF, function (text) { return _this.formatToCpf(text); });
        this.maskFormatMap.set(InputType.CNPJ, function (text) { return _this.formatToCnpj(text); });
        this.maskFormatMap.set(InputType.PHONE, function (text) { return _this.formatToPhone(text); });
        this.maskFormatMap.set(InputType.NUMBER, function (text) { return _this.formatToNumber(text); });
        this.maskFormatMap.set(InputType.NO_FORMAT, function (text) { return _this.formatToNothing(text); });
        this.maskFormatMap.set(InputType.ZIPCODE, function (text) { return _this.formatToZipCode(text); });
        this.maskFormatMap.set(InputType.CURRENCY, function (text) { return _this.formatToCurrency(text); });
        this.maskFormatMap.set(InputType.PERCENT, function (text) { return _this.formatToPercent(text); });
    };
    ...
    return FourwardInputMaskComponent;
}());
...
var FourwardInputMaskModule = /** @class */ (function () {
    function FourwardInputMaskModule() {
    }
    ...
    return FourwardInputMaskModule;
}());
